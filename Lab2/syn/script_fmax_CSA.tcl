...
elaborate fpmul_pipeline -arch pipeline -lib WORK > ./elaborate_fmax_CSA.txt
uniquify
link
create_clock -name MY_CLK -period 4.42 clk
...
compile
report_area > fmax_CSA_report.txt
report_timing >> fmax_CSA_report.txt
ungroup -all -flatten
